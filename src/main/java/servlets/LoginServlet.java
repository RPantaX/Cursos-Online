...
public class LoginServlet extends HttpServlet {
	...
	private void validarUsuario(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		UsuarioDTO objUsu = fabrica.getUsuarioDAO().validarUsuario(usuario, contrasena);
		...
		if (objUsu!=null) {
			...
			ClienteDTO objCliente = fabrica.getClienteDAO().obtenerDatosClienteLogeado(usuario, contrasena);
			
			request.getSession().setAttribute("datosUsuario", objCliente);
