...
<%@ include file="../comun/menu.jsp" %>
    ...
    <div class="container" style="display: flex;">	
		    <img src="images/addUser64.png">
		    <h1 class="h1 mb-3 font-weight-normal">Registrar Cliente</h1>
	</div> 
				            ...
				            <div class="col-md-12">
				                ...
				                <div class="form-row">
					                <div class="form-group col-md-6">
					                    ...
					                    <input type="text" class="form-control" id="txtUserName" name="txtUserName" value="${docente.celular}">
					                </div>
					                 <div class="form-group col-md-6"">
					                    <label for="txtPassword">Contraseña</label>
				                    	<input type="password" class="form-control" id="txtPassword" name="txtPassword" value="${docente.celular}">
					                </div>
				                </div> 
				              	<br>
