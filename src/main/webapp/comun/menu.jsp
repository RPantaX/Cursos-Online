...
<body> 
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="loginServlet?opcion=ini" style="font-weight: bold;">Cursos Online</a>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="menuPerfil">
                        <a class="dropdown-item" href="docenteServlet?opcion=lis">Docentes</a>
                        <a class="dropdown-item" href="cursoServlet?opcion=lis"> Cursos</a>
                        <a class="dropdown-item" href="clienteServlet?opcion=lis">Clientes</a>
                    </div>
                </li>
                
                <li class="nav-item">
                    <a class="nav-link" href="ventaServlet?opcion=lis">
                        Cursos
                    </a>
        ...
        <span class="navbar-text ml-auto">
            Bienvenido,  <strong>   ${datosUsuario.nombre}   ${datosUsuario.apePaterno}   ${datosUsuario.apeMaterno} </strong>
        </span>
    </nav>
